...
const RULES: { index: string; title: string; body: string; items?: { label: string; value: string }[] }[] =
  [
    ...
    },
    {
      ...
      body: "Мы ставим лимит на ту сторону, за которую рынок платит меньше. DOWN — точное дополнение UP, поэтому ровно один из двух ask всегда ниже 0.50, и лимит 0.50 достижим всегда.",
    },
    {
      index: "04",
      ...
      items: [
        { label: "Возврат к лимиту", value: "80% случаев" },
        { label: "Удержавшиеся выигрывают", value: "47%" },
        { label: "Возврат удержавшихся", value: "20%" },
    ...
    <section className="surface border border-border p-5 sm:p-6">
      <header>
        ...
        <p className="mt-1 max-w-2xl text-xs leading-relaxed text-muted-foreground">
          ...
          рынок. Рынок 5-минутный: раундов втрое больше, поэтому стратегия срабатывает чаще, но
          и перевес тоньше.
        </p>
      </header>
