...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    body: "Для входа нужны одновременно: |score| от 0.22 до 0.60 без перегрева, confidence ≥ 60%, согласие ≥ 55%, минимум 4 из 6 факторов по направлению, режим normal и отсутствие RSI-перегрева. Это резко сокращает число сделок, но убирает импульсные ложные входы.",
  },
  {
    index: "03",
  ...
  },
  {
    ...
    body: "Confidence больше не решает, входить ли. Вход разрешён только при достаточном согласии факторов, нормальной волатильности и без RSI-перегрева.",
    items: [
