...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    body: "Вызов публикуется, только если перевес |score| ≥ 0.22 и уверенность ≥ 60%. Максимальная цена входа = уверенность − 6 п.п. Если контракт на Binance стоит дороже — сделки нет.",
  },
  {
    index: "03",
  ...
  },
  {
    index: "04",
    title: "Фильтры риска",
    body: "Факторы дают направление, фильтры срезают уверенность — и, значит, допустимую цену входа.",
    items: [
