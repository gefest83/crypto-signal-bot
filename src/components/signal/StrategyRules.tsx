...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    body: "Перевес +1.9% — это до спреда и до риска неполного исполнения: лимит может не набраться. Тик на этих рынках 0.01, ликвидность отдельных раундов тонкая, объём не масштабируется. Статистика 15 дней — 2.4σ, а не гарантия.",
    items: [
