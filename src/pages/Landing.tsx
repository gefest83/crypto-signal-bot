...
const MECHANISM = [
  ...
  },
  {
    ...
    body: "Лимит набивается тем, кто прав: стейк в $1 уходит в минус почти целиком, около −30 центов на сделку. Отбор не обойти — он и есть смысл лимитной заявки.",
    icon: ArrowDown,
  },
  {
    title: "Выход делает всю работу",
    body: "Контракт возвращается к цене входа в 91% случаев. В этот момент мы продаём и закрываем сделку за 8 центов, а убыток ограничен спредом и комиссией, а не всей ставкой.",
    icon: Repeat,
  },
  {
...
const ROUND_STEPS = [
  ...
  },
  {
    ...
    body: "Bid снова на нашем уровне. Продаём: 2 цента проскальзывания плюс 2% комиссии — на стейк $1 это 8 центов.",
  },
  {
    time: "12:14:00",
    title: "Расчёт",
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-4 pt-16 pb-20 sm:px-6 lg:grid-cols-[1.08fr_1fr] lg:pt-24 lg:pb-28">
          ...
          >
            ...
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
              ...
              съедала комиссия тейкера — целиком. Лимитная заявка платит только 2% от
              стейка, а выход по цене входа ограничивает убыток восемью центами на
              доллар. Заявка минимальная — $1, это и есть весь риск на сделку.
            </p>

            <div className="mt-7 grid max-w-lg grid-cols-3 gap-3">
              {[
                { label: "P&L на $1 стейк", value: "+3.7¢", tone: "text-emerald-500" },
                { label: "Проигрышных дней", value: "8 из 31" },
