...
const MECHANISM = [
  ...
  },
  {
    ...
    body: "Лимит набивается тем, кто прав: стейк в $1 уходит в минус почти целиком, −29 центов на сделку. Отбор не обойти — он и есть смысл лимитной заявки.",
    icon: ArrowDown,
  },
  {
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-4 pt-16 pb-20 sm:px-6 lg:grid-cols-[1.08fr_1fr] lg:pt-24 lg:pb-28">
          ...
          >
            ...
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
              ...
              выход по цене входа ограничивает убыток двумя центами. Заявка
              минимальная — $1, это и есть весь риск на сделку.
            </p>

            <div className="mt-7 grid max-w-lg grid-cols-3 gap-3">
              {[
                { label: "P&L на $1 стейк", value: "+6¢", tone: "text-emerald-500" },
