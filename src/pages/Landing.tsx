...
const MECHANISM = [
  ...
  },
  {
    ...
    body: "Контракт возвращается к цене входа в 80% случаев. В этот момент мы продаём и закрываем сделку за 9 центов, а убыток ограничен спредом и комиссией, а не всей ставкой.",
    icon: Repeat,
  },
  {
    title: "Держатся только победители",
    body: "20% сделок не возвращаются к лимиту — именно они доходят до расчёта. И выигрывают в 47% случаев: едва больше монетки. Поэтому весь перевес держится на выходе.",
    icon: ArrowUp,
  },
  {
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-4 pt-16 pb-20 sm:px-6 lg:grid-cols-[1.08fr_1fr] lg:pt-24 lg:pb-28">
          ...
          >
            ...
            <div className="mt-7 grid max-w-lg grid-cols-3 gap-3">
              {[
                { label: "P&L на $1 стейк", value: "+1.8¢", tone: "text-emerald-500" },
                { label: "Проигрышных дней", value: "9 из 31" },
