...
const TIMELINE = [
  ...
  },
  {
    time: "12:05:02",
    title: "Первый расчёт",
    body: "Импульс положительный, EMA 9 выше EMA 21, доля агрессивных покупок 57%, VWAP растёт. Перевес +0.31.",
  },
  {
    time: "12:05:06",
    title: "Вызов зафиксирован",
    body: "UP, уверенность 74%, максимальная цена входа 0.68. Запись уходит в журнал и больше не меняется.",
  },
  {
    time: "12:05:40",
    title: "Вход",
    body: "Контракт на Binance стоит 0.58 — ниже порога, перевес есть. Позиция взята на 8-й секунде раунда.",
  },
  {
    time: "12:07:10",
    title: "Окно закрыто",
    body: "Уверенность затухла, вход запрещён. Контракт уже 0.79: перевес у рынка, а не у нас.",
  },
  {
    time: "12:10:00",
    title: "Расчёт",
...
const DISCIPLINE = [
  ...
  },
  {
    ...
    body: "60–150 секунд — коэффициент 0.82, поздняя фаза — 0.58 и полный запрет входа. Поздний вызов ничего не стоит.",
    icon: Clock,
  },
  {
    ...
    <div className="surface relative overflow-hidden border border-up/25 bg-[linear-gradient(150deg,var(--up-soft),transparent_60%)] p-5 sm:p-6">
      ...
      <div className="mt-6 grid grid-cols-3 gap-3">
        ...
        <div className="rounded-xl border border-border/70 bg-card/70 px-3 py-2.5">
          ...
          <p className="mt-1 font-mono text-xl tabular-nums">0.68</p>
        </div>
        <div className="rounded-xl border border-border/70 bg-card/70 px-3 py-2.5">
          <p className="text-[10px] tracking-wider text-muted-foreground uppercase">
            Окно
          </p>
          <p className="mt-1 font-mono text-xl tabular-nums">0:37</p>
        </div>
      </div>
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-4 pt-16 pb-20 sm:px-6 lg:grid-cols-[1.08fr_1fr] lg:pt-24 lg:pb-28">
          ...
          >
            ...
            <h1 className="mt-5 text-[2.5rem] leading-[1.05] font-semibold tracking-tight text-balance sm:text-5xl lg:text-[3.4rem]">
              Вызов Up или Down — пока контракт ещё дешёвый
            </h1>
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
              Цена 5-минутного контракта переоценивается в первые секунды раунда.
              Early Push считает перевес по 1-минутным свечам, потоку тейкеров и
              волатильности и публикует один вызов сразу после открытия — с ценой
              входа, выше которой сделка теряет смысл.
            </p>
      ...
      <section className="border-t border-border/70 bg-card/50">
        <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
          <SectionHeading
            ...
            title="Поздний вызов ничего не стоит, ранний — стоит денег"
            body="Рынок дооценивает движение за минуты. Задача движка — увидеть перевес по данным, которые уже есть на первой секунде раунда, и успеть до того, как эта информация окажется в цене контракта."
          />
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {[
              {
                title: "Цена контракта уезжает первой",
                body: "Как только цена пошла, вероятность в контракте растёт. Вход на третьей минуте — это покупка того же исхода по цене, из которой перевес уже извлечён.",
                icon: Clock,
              },
              {
                title: "Ранний вызов требует ранних данных",
                body: "Свечи по 1 минуте, доля агрессивных покупок, VWAP и волатильность пересчитываются каждую секунду — вызов готов через несколько тиков после открытия раунда.",
                icon: Activity,
              },
              {
